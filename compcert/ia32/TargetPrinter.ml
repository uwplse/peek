...
let bfloat_reg_name = function
  | Coq_xmm0 -> "%xmm0"  | Coq_xmm1 -> "%xmm1"  | Coq_xmm2 -> "%xmm2"  | Coq_xmm3 -> "%xmm3"
  | Coq_xmm4 -> "%xmm4"  | Coq_xmm5 -> "%xmm5"  | Coq_xmm6 -> "%xmm6"  | Coq_xmm7 -> "%xmm7"
...
let bfreg oc r = output_string oc (bfloat_reg_name r)
...
(* Reminder on AT&T syntax: op source, dest *)
    ...
    let print_instruction oc = function
      ...
      | Pmov_mi(a, n) ->
          fprintf oc "	movl	$%ld, %a\n" (camlint_of_coqint n) addressing a
      | Pmovsd_ff(rd, r1) ->
          fprintf oc "	movapd	%a, %a\n" freg r1 freg rd
      | Pmovsd_fi(rd, n) ->
      ...
      | Pmovups_rm(rd, a) ->
          fprintf oc "	movups	%a, %a\n" addressing a bfreg rd
      | Pmovups_mr(a, r1) ->
          fprintf oc "	movups	%a, %a\n" bfreg r1 addressing a
      ...
      | Paddpd_ff(rd, r1) ->
          fprintf oc "	addpd	%a, %a\n" bfreg r1 bfreg rd
      | Pmulpd_ff(rd, r1) ->
          fprintf oc "	mulpd	%a, %a\n" bfreg r1 bfreg rd
      | Psubd_ff(rd, r1) ->
