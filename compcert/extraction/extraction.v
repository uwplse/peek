...
(* Definition quote := String (Ascii.Ascii false true false false false true false false) EmptyString. *)

(* psur *)
Extract Constant MemoryAxioms.psur => "fun _ -> failwith ""psur"" ".
...
Extract Constant Compopts.optim_peeps =>
  "fun _ -> !Clflags.option_fpeeps".
